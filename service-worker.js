const CACHE_NAME = 'cristobal-portfolio-v1.2';
const urlsToCache = [
    '/',
    '/index.html',
    '/projects.html',
    ...
    '/media/covers/skinautica_cover.jpg',
    '/media/covers/preview_card.jpg',
    '/media/backgrounds/bg.jpg',
    '/media/backgrounds/overlay.png'
];
